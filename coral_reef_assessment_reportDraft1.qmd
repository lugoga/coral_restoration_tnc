...
recruit_ung |> 
  ...
  arrange(desc(`Chama Kangu`)) |> 
  gt() |>
  tab_spanner(columns = -1, label = md('Recruit Density (individuals per 100m^2^)')) |> 
  cols_width( 
    family ~ px(150),
    `Chama Kangu` ~ px(150),
    `Mwamba Mrefu` ~ px(150),
...
filter(density_100m2 > 0) |> 
  ...
  # flextable::flextable() |> 
  gt() |>
  tab_spanner(columns = -1, label = md('Invertebrates (individuals per 100m^2^)'))  |> 
  cols_width( 
    family ~ px(150),
    `Chama Kangu` ~ px(150),
     `Mwamba Mrefu` ~ px(150),
...
filter(density_100m2 > 0) |> 
  ...
  # flextable::flextable() |> 
  gt() |>
  tab_spanner(columns = -1, label = md('Density (individuals per 100m^2^)'))  |> 
  cols_width( 
    family ~ px(150),
    `Chamba Cha Kati` ~ px(150),
    everything() ~ px(70)
